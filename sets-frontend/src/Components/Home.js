    ...
    return (<div className='container mt-5'>
                ...
                <div className="row row-cols-1 row-cols-md-3 row-cols-lg-4 g-4 justify-content-center mt-3">
                    <Link className='no-underline' to='/singleplayer'>
                        <div className="col d-flex justify-content-center text-center mb-3">
                            <div className='Home-menu-item' style={{width:'75%'}} >
                                <img src={oneCircle}  className="shadow-lg rounded Home-image" style={{width:'100%'}} alt="..."/>
                    ...
                    <Link className='no-underline' to='/multiplayer'>
                        <div className="col d-flex justify-content-center text-center mb-3">
                            <div className='Home-menu-item' style={{width:'75%'}} >
                                <img src={threeSquares}  className="mx-auto shadow-lg rounded Home-image" style={{width:'100%'}} alt="..."/>
                    ...
                    <Link className='no-underline' to='/lobby'>
                        <div className="col d-flex justify-content-center text-center mb-3">
                            <div className='Home-menu-item' style={{width:'75%'}} >
                                <img src={twoTriangles} className="mx-auto shadow-lg rounded Home-image" style={{width:'100%'}} alt="..."/>
