...
var index = require('./discovery/index.js');
...
class Server {
    constructor(options = {}) {
        this.processId = Utils.generateId();
  ...
  transport: new WebSocketTransport({
    ...
    listen(port, hostname, backlog, listeningListener) {
        return tslib_es6.__awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                var _a;
                (_a = this.transport.server) === null || _a === void 0 ? void 0 : _a.on('error', (err) => reject(err));
    ...
    registerProcessForDiscovery() {
        ...
        index.registerNode(this.presence, {
            port: this.port,
    ...
    gracefullyShutdown(exit = true, err) {
        return tslib_es6.__awaiter(this, void 0, void 0, function* () {
            yield index.unregisterNode(this.presence, {
                port: this.port,
                processId: this.processId,
            });
            try {
    ...
    handleMatchMakeRequest(req, res) {
        return tslib_es6.__awaiter(this, void 0, void 0, function* () {
            ...
            if (req.method === 'OPTIONS') {
                ...
                req.on('end', () => tslib_es6.__awaiter(this, void 0, void 0, function* () {
                    headers['Content-Type'] = 'application/json';
                    res.writeHead(200, headers);
                    const clientOptions = JSON.parse(Buffer.concat(data).toString());
                    try {
                        const response = yield controller.invokeMethod(method, name, clientOptions);
                ...
                headers['Content-Type'] = 'application/json';
                res.writeHead(200, headers);
                res.write(JSON.stringify(yield controller.getAvailableRooms(roomName)));
                res.end();
            }
        });
    }
