...
require('../build/Debug.mjs.js');
require('../build/Protocol.mjs.js');
require('../build/Utils.mjs.js');
require('events');
require('../build/Room.mjs.js');
var index = require('../build/matchmaker/driver/index.mjs.js');
require('internal-ip');
require('../build/Transport.mjs.js');
require('@colyseus/schema');
require('../build/rooms/RelayRoom.mjs.js');
require('./Protocol.js');
